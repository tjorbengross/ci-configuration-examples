[![MATLAB](https://github.com/tjorbengross/ci-configuration-examples/actions/workflows/ci.yml/badge.svg)](https://github.com/tjorbengross/ci-configuration-examples/actions/workflows/ci.yml) 
